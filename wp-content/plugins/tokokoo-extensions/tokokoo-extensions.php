...
class Tokokoo_Extensions {
	...
	public function constants() {
		...
		/* Sets the path to the core metabox directory. */
		define( 'TOKOKOO_EXTENSIONS_CMB_METABOX', trailingslashit( TOKOKOO_EXTENSIONS_DIR ) . 'cmb-metabox' );
	...
	public function metabox() {
		...
		/* Load the custom cmb metabox functions. */
		require_once( trailingslashit( TOKOKOO_EXTENSIONS_INCLUDES ) . 'cmb-metabox.php' );

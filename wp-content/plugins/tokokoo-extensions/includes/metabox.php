...
function tokokoo_register_repeater_field() {
	require_once( trailingslashit( TOKOKOO_EXTENSIONS_METABOX ) . 'addons/acf-repeater/repeater.php' );
}
...
function tokokoo_register_gallery_field() {
	require_once( trailingslashit( TOKOKOO_EXTENSIONS_METABOX ) . 'addons/acf-gallery/gallery.php' );
}
...
if( function_exists( 'register_field_group' ) ) {
	...
	register_field_group( array (
		...
		'fields' => array (
			array (
				'key' => 'field_529845846bea9',
				'label' => 'Photo Gallery',
				'name' => 'tokokoo_photo_gallery',
				'type' => 'repeater',
				'instructions' => 'Upload the photo images as many as you want!',
				'sub_fields' => array (
					array (
						'key' => 'field_529845f76beab',
						'label' => 'Image',
						'name' => 'tokokoo_photo_image',
						'type' => 'image',

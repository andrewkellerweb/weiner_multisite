...
function tokokoo_toggle_shortcode( $atts, $content = null ) {
	...
	return "<div data-id='" . esc_attr( $state ) . "' class=\"koo-toggle\"><span class=\"koo-toggle-title\">" . esc_attr( $title ) . "</span><div class=\"koo-toggle-inner\">". do_shortcode( wpautop( $content ) ) ."</div></div>";
}
